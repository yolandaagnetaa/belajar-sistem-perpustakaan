...
<html>
	...
	<body id="main" class="<?php echo $body_class ?>">
			...
			<div id="main-content">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Elimina record</h5>
							...
							<div class="modal-footer">
								...
								<a href="" id="delete-record-modal-btn" class="btn btn-primary">Elimina</a> 
							</div>
						</div>
					</div>
				</div>
				...
				<template id="page-loading-indicator">
					<div class="p-2 text-center m-2 text-muted m-auto">
						...
						<h4 class="p-3 mt-2 font-weight-light">Caricamento in corso...</h4>
					</div>
				</template>
				<template id="page-saving-indicator">
					<div class="p-2 text-center m-2 text-muted">
						<div class="lds-dual-ring"></div>
						<h4 class="p-3 mt-2 font-weight-light">Salvataggio del record</h4>
					</div>
				</template>
		...
		<?php
			...
			Html ::  page_js('locale/flatpickr/italian.js');
