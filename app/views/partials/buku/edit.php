...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">modificare</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-isbn"  value="<?php  echo $data['isbn']; ?>" type="text" placeholder="accedere  Isbn"  required="" name="isbn"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_kategori"  value="<?php  echo $data['id_kategori']; ?>" type="text" placeholder="accedere  Id Kategori"  required="" name="id_kategori"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-judul"  value="<?php  echo $data['judul']; ?>" type="text" placeholder="accedere  Judul"  required="" name="judul"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-pengarang"  value="<?php  echo $data['pengarang']; ?>" type="text" placeholder="accedere  Pengarang"  required="" name="pengarang"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-penerbit"  value="<?php  echo $data['penerbit']; ?>" type="text" placeholder="accedere  Penerbit"  required="" name="penerbit"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-tahun"  value="<?php  echo $data['tahun']; ?>" type="text" placeholder="accedere  Tahun"  required="" name="tahun"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-stok"  value="<?php  echo $data['stok']; ?>" type="number" placeholder="accedere  Stok" step="1"  required="" name="stok"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <textarea placeholder="accedere  Image" id="ctrl-image"  required="" rows="5" name="image" class=" form-control"><?php  echo $data['image']; ?></textarea>
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-created_at"  value="<?php  echo $data['created_at']; ?>" type="text" placeholder="accedere  Created At"  required="" name="created_at"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
