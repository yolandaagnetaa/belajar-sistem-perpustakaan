                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-remember_token">
                                                        <span  data-value="<?php echo $data['remember_token']; ?>" 
                                                            ...
                                                            data-title="accedere  Remember Token" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="Visualizza Record" href="<?php print_link("users/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> vista
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Modifica questo record" href="<?php print_link("users/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> modificare
                                                        </a>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Elimina questo record" href="<?php print_link("users/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Sei sicuro di voler cancellare questo record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <button data-prompt-msg="Sei sicuro di voler eliminare questi record?" data-display-style="modal" data-url="<?php print_link("users/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
